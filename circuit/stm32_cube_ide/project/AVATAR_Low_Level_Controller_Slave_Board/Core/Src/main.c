...
#include "low_level_controller_slave_callbacks.h"
...
void SPITaskFunction(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(spiTask, SPITaskFunction, osPriorityNormal, 0, 128);
  spiTaskHandle = osThreadCreate(osThread(spiTask), NULL);

  /* definition and creation of uartTask */
  osThreadDef(uartTask, UARTTaskFunction, osPriorityHigh, 0, 128);
...
/* USER CODE BEGIN Header_SPITaskFunction */
/**
* @brief Function implementing the spiTaskHandle thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_SPITaskFunction */
void SPITaskFunction(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
